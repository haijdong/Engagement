...
public class RotateLoadingLayout extends LoadingLayout {
    ...
    private void init(Context context) {
        ...
        mArrowImageView.setImageResource(R.drawable.pull_updown_rotate);
    ...
    protected View createLoadingView(Context context, AttributeSet attrs) {
        View container = LayoutInflater.from(context).inflate(R.layout.pull_updown_header, null);
        return container;
    }
    ...
    private void resetRotation() {
        ...
        mHeaderImageMatrix.setRotate(0);
        mArrowImageView.setImageMatrix(mHeaderImageMatrix);
    }
}
