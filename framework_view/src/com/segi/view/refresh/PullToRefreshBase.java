...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private final long MIN_REFRESH_TIME = 2*1000L;//最低刷新2秒钟
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (isPullRefreshEnabled() && isReadyForPullDown()) {
                    ...
                    if ( Math.abs(getScrollYValue()) <= mHeaderHeight){
...
//                    mHeaderLayout.setState(State.RESET);
//                }
//            }, ((MIN_REFRESH_TIME - (System.currentTimeMillis() - lastRefreshTime))>0?(MIN_REFRESH_TIME - (System.currentTimeMillis() - lastRefreshTime)):0));
//            setInterceptTouchEventEnabled(false);
        }
    }
