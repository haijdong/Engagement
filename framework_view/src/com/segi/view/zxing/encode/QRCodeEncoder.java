...
package com.segi.view.zxing.encode;
...
import com.segi.view.zxing.Contents;
import com.segi.view.zxing.Intents;
...
public final class QRCodeEncoder {
  ...
  private void encodeFromStreamExtra(Intent intent) throws WriterException {
    ...
    Logger.d(TAG, "Encoding share intent content:");
    Logger.d(TAG, vcardString);
   ...
   * @return
   */
  public static Bitmap simpleEncodeQRcode(Context context, String codeContent, int wh)
  {
    Intent intent = new Intent();
    intent.setAction(Intents.Encode.ACTION);
    intent.putExtra(Intents.Encode.FORMAT, BarcodeFormat.QR_CODE.toString());
    intent.putExtra(Intents.Encode.TYPE, Contents.Type.TEXT);
    intent.putExtra(Intents.Encode.DATA, codeContent);
    try {
      return new QRCodeEncoder(context, intent, wh, false).encodeAsBitmap();
