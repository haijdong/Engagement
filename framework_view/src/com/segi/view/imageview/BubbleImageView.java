...
//		Log.e("BubbleImageView", "moveTo mAngle: " + mAngle);
//		Log.e("BubbleImageView", "moveTo rect.top: " + rect.top);
		path.lineTo(rect.width(), rect.top);
//		Log.e("BubbleImageView", "lineTo rect.width(): " + rect.width());
//		Log.e("BubbleImageView", "lineTo rect.top: " + rect.top);
		path.arcTo(new RectF(rect.right - mAngle * 2 - mArrowWidth, rect.top,
				rect.right - mArrowWidth, mAngle * 2 + rect.top), 270, 90);
//		Log.e("BubbleImageView", "arcTo x1: " + (rect.right - mAngle * 2 - mArrowWidth));
//		Log.e("BubbleImageView", "arcTo y1: " + rect.top);
//		Log.e("BubbleImageView", "arcTo x2: " +(rect.right - mArrowWidth) );
//		Log.e("BubbleImageView", "arcTo y2: " + mAngle * 2 + rect.top);
		path.lineTo(rect.right - mArrowWidth, mArrowTop);
//		Log.e("BubbleImageView", "lineTo rect.right - mArrowWidth: " + (rect.right - mArrowWidth));
//		Log.e("BubbleImageView", "lineTo mArrowTop: " + mArrowTop);
		path.lineTo(rect.right, mArrowTop - mArrowOffset);
//		Log.e("BubbleImageView", "lineTo rect.right : " + rect.right);
//		Log.e("BubbleImageView", "lineTo mArrowTop - mArrowOffset: " + (mArrowTop - mArrowOffset));
		path.lineTo(rect.right - mArrowWidth, mArrowTop + mArrowHeight);
//		Log.e("BubbleImageView", "lineTo rect.right - mArrowWidth: " + (rect.right - mArrowWidth));
//		Log.e("BubbleImageView", "lineTo mArrowTop + mArrowHeight : " + (mArrowTop + mArrowHeight));
		path.lineTo(rect.right - mArrowWidth, rect.height() - mAngle);
//		Log.e("BubbleImageView", "lineTo rect.right - mArrowWidth : " + (rect.right - mArrowWidth));
//		Log.e("BubbleImageView", "lineTo rect.height() - mAngle: " + (rect.height() - mAngle));
		path.arcTo(new RectF(rect.right - mAngle * 2 - mArrowWidth, rect.bottom
				- mAngle * 2, rect.right - mArrowWidth, rect.bottom), 0, 90);
//		Log.e("BubbleImageView", "arcTo x1: " + (rect.right - mAngle * 2 - mArrowWidth));
//		Log.e("BubbleImageView", "arcTo y1: " + (rect.bottom - mAngle * 2));
//		Log.e("BubbleImageView", "arcTo x2: " +(rect.right - mArrowWidth) );
//		Log.e("BubbleImageView", "arcTo y2: " + rect.bottom);
		path.lineTo(rect.left, rect.bottom);
//		Log.e("BubbleImageView", "lineTo rect.left : " + rect.left);
//		Log.e("BubbleImageView", "lineTo rect.bottom: " + rect.bottom);
		path.arcTo(new RectF(rect.left, rect.bottom - mAngle * 2, mAngle * 2
				+ rect.left, rect.bottom), 90, 90);
//		Log.e("BubbleImageView", "arcTo x1: " + rect.left);
//		Log.e("BubbleImageView", "arcTo y1: " + (rect.bottom - mAngle * 2));
//		Log.e("BubbleImageView", "arcTo x2: " +( mAngle * 2+ rect.left) );
//		Log.e("BubbleImageView", "arcTo y2: " + rect.bottom);
