 ...
 * <p>文字展开收起控件</p>
 * <p>copy by liangzx</p>
 * link: https://github.com/Manabu-GT/ExpandableTextView
 */
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
    ...
    private String mExpandTxt;

    private String mCollapseTxt;
    ...
    public void onClick(View view) {
        ...
        mButton.setText(mCollapsed ? mExpandTxt : mCollapseTxt);
    ...
    public void setTextSize(int px) {
        mTv.setTextSize(TypedValue.COMPLEX_UNIT_PX, px);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        mExpandTxt = typedArray.getString(R.styleable.ExpandableTextView_expandTxt);
        mCollapseDrawable = typedArray.getDrawable(R.styleable.ExpandableTextView_collapseDrawable);
        mCollapseTxt = typedArray.getString(R.styleable.ExpandableTextView_collapseTxt);
