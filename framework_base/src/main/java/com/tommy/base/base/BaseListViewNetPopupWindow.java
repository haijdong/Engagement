 ...
 **/
public abstract class BaseListViewNetPopupWindow<T> extends BaseNetRequestPopupWindow implements View.OnClickListener, AdapterView.OnItemClickListener {
     ...
     * @param data
     */
    public BaseListViewNetPopupWindow(Context context, ArrayList<T> data) {
        super(context);
    ...
    {
        if (null != mListView && null != adapter) {
